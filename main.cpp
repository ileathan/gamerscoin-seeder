...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "gamerscoin-seeder\n"
...
static const string mainnet_seeds[] = {"37.120.160.213", "188.226.169.29", "46.38.232.74", ""};
static const string testnet_seeds[] = {"testnet-armor.ignorelist.com", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    printf(" ... No tor seeds ...");
    // db.Add(CService("kjy2eqzk4zwi5zd3.onion", 40002), true); Need to add a .onion pdns
  }
  do {
